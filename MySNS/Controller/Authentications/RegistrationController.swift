...
class RegistrationController: UIViewController {
    ...
    private let plusPhotoButton: UIButton = {
        ...
        button.setImage(UIImage(named: "plugImage"), for: UIControl.State.normal)
        button.tintColor = .white
        button.addTarget(self, action: #selector(handleProfilePhotoSelect),
    ...
    func configureUI() {
        ...
        let stack = UIStackView(arrangedSubviews: [emailTextField, passwordTextField, fullnameTextField,
